...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-20 pb-24 lg:pt-40 lg:pb-56 overflow-hidden bg-white dark:bg-black transition-colors duration-500">
      ...
      >
        <div className="max-w-6xl">
          ...
          <h1 className="text-6xl md:text-[8rem] font-hero font-bold text-slate-900 dark:text-white leading-[0.95] mb-12 tracking-[-0.06em]">
            Obsidian <br />
            <span className="gradient-text-mono italic inline-block pb-3 pr-6">
              Intelligence
            </span>
          </h1>
          ...
          <p className="text-2xl md:text-3xl text-slate-500 dark:text-slate-400 leading-tight mb-20 max-w-3xl font-medium tracking-tight">
            We build the cognitive infrastructure that runs high-stakes
            enterprise. Clinical execution meets frontier research.
          </p>
          ...
          <div className="mt-40 pt-16 border-t border-slate-100 dark:border-white/10 grid grid-cols-2 md:grid-cols-4 gap-16">
            {[
              ...
              <div key={idx} className="space-y-3">
                <p className="text-4xl font-hero font-bold text-slate-900 dark:text-white tracking-tight leading-none">
                  {stat.value}
                </p>
      ...
      {/* Hero Asset */}
      <div className="absolute right-[2%] top-[15%] w-[35%] aspect-square hidden lg:block opacity-10 dark:opacity-20 pointer-events-none">
        <div className="relative w-full h-full">
          ...
          <img
            ...
            alt="Strategic Intelligence Visualization"
